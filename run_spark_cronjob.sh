...
echo "Deploying Spark CronJob (runs every 10 minutes)..."
...
echo ""
echo "CronJob will run every 10 minutes automatically."
echo ""
...
echo "  • Trigger manually:    kubectl create job --from=cronjob/spark-hdfs-to-es-cron spark-manual"
